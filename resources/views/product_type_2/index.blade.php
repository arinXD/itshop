                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="https://img.freepik.com/premium-vector/cardboard-boxes-side-view-vector-illustration-business-cargo-object-icon-concept_722324-406.jpg?w=360"
                                ...
                                @empty
                                    <tr>
                                        <td class="text-center" colspan="4">ไม่มีข้อมูลหมวดหมู่</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
