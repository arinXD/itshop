                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    ...
                                                    <p class="text-xs text-secondary mb-0">{{ $product->price }} บาท</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <p class="text-xs font-weight-bold mb-1">{{ $product->qty }}</p>
                                ...
                                @empty
                                    <tr>
                                        <td class="text-center" colspan="4">ไม่มีข้อมูลสินค้า</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
